...
/*   Updated: 2025/10/10 00:53:23 by retahri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// pipe
bool					setup_with_backup(t_cmd *cmd, int *save_stdout,
							int *save_stdin);
void					reset_and_catch_sig(t_shell *shell, int status,
							bool toggle);
void					setup_io(t_cmd *cmd, int prev_fd, int pipedes[2]);
void					ex_child(t_shell *shell, t_cmd *cmd, int prev_fd,
							int pipedes[2]);
